...
Как только все контейнеры запустятся, вы можете зайти на страницу `http://localhost:3000`. После ввода имени пользователя и пароля вы можете поиграть с приложением.
