    ...
    <v-app>
        ...
        <template v-slot:activator="{ props }">
          <v-btn
            ...
            <v-avatar
              ...
              size="40">
              <span class="text-h6"
              style="font-weight: 400;">{{userInitials}}</span>
            </v-avatar>
          </v-btn>
        </template>
        <v-card>
      ...
      >  
        <v-list density="compact" nav>
          <v-list-item prepend-icon="mdi-folder" title="My Files" value="myfiles" rounded="xl"></v-list-item>
          <v-list-item prepend-icon="mdi-account-multiple" title="Shared with me" value="shared" rounded="xl"></v-list-item>
          <v-list-item prepend-icon="mdi-star" title="Starred" value="starred" rounded="xl"></v-list-item>
        </v-list>
      </v-navigation-drawer>
